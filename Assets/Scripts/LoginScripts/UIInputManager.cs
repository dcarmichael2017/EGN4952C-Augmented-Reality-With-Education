...
public class UIInputManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        _loading = GameObject.Find("LoadingText");
        _welcome = GameObject.Find("WelcomeText");
        _confirmEmail = GameObject.Find("ConfirmEmailText");
        _signupContainer = GameObject.Find("SignUpContent");
